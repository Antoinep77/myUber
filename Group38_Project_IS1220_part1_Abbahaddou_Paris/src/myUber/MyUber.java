...
public class MyUber {
	...
	/**
	 * MyUber constructor to create an instance with some cars and drivers to test different methods
	 * @param test is useless, this parameter just to get a different signature from the no parameter constructor
	 */
	 ...
	 * @param type the String that match with the type of car in the CarFactory class
	...
	/**
	 * Compute the prices of all types of rides in function of the parameter and
	 * add messages to the box of the customer specified in parameter to give him the prices
	 * 
	 ...
	 * @return an instance of RideFactory constructed with the list of the different types of rides.
	 * Use the require method on this instance to choose the type of ride to require
	 */
	...
	/**
	 * Add this ride to the list of rides of this MyUber instance and allocate a driver to the ride
	 ...
	 * @return the nearest driver if there is at least one driver, else the method returns null
	 */
	...
	/**
	 * Use this method to make a driver refuse a ride.
	 * The system will then try to find an other driver for the ride.
	 * This method only works if the status of the ride is unconfirmed.
	...
	//only works if the ride is unconfirmed
	/**
	 * Use this method to make a driver accept a ride
	 * This method only works if the status of the ride is unconfirmed.
	 ...
	 * This method only works if the ride is completed and the ride hasn't already be marked
	...
	/**
	 * Cancel the ride.
	 * Only works if the ride is confirmed or unconfirmed, the customer cannot cancel ongoing rides.
	...
	/**
	 * Notify the system that a ride has finished.
	 * The method only works if the ride is ongoing.
	 * The method also set the car and the customer positions to the destination point of the ride
